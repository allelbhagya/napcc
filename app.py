...
st.set_page_config(page_title="Climate RAG", layout="centered")
st.title("NAPCC")

if "index" not in st.session_state:
    with st.spinner("Reading"):
        chunks, embeddings, embed_model, index = prepare_rag_inputs("data/NAPCC.pdf")
        st.session_state.chunks = chunks
        st.session_state.embed_model = embed_model
        st.session_state.index = index

query = st.text_input("Ask the NAPCC document:")
